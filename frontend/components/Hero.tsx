      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-16 w-full">
        ...
        <div className="max-w-[700px] mb-10">
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-[52ch] text-wrap-balance">
            Hundreds of vehicles, every city, at prices that make sense.
          </p>
        </div>
        ...
        <div className="max-w-3xl bg-white rounded-2xl shadow-2xl p-5 text-gray-800">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4">
            ...
            <div className="flex items-center gap-3 pr-4">
              ...
              <div>
                <p className="text-base font-semibold text-slate-800 leading-snug">Jul 08 - Jul 11</p>
            ...
            {/* Search button */}
            <button
              className="ml-auto bg-sky-600 text-white w-12 h-12 rounded-full flex items-center justify-center hover:bg-sky-700 active:scale-[0.96] transition-all flex-shrink-0 shadow-md shadow-sky-300/40"
