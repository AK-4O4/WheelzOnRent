            ...
            <div className="mx-auto max-w-6xl">
                <div className="flex items-end justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            type="button"
                            className="grid size-8 place-items-center rounded-md border border-border/60 hover:bg-foreground/4"
                        >
                        ...
                        <div className="ml-2 flex items-center rounded-md border border-border/60 p-0.5 font-mono text-[10px] uppercase tracking-[0.2em]">
                            ...
                            <button
                                type="button"
                                className="rounded bg-foreground/8 px-2 py-1"
                            >
                                Month
                            </button>
                        </div>
                        ...
                        {Array.from({ length: rows * 7 }).map((_, i) => {
                            ...
                            return (
                                <div
                                    key={i}
                                    className={
                                        "min-h-27.5 border-border/40 border-r border-b p-1.5 last-of-type:border-r-0 " +
                                        (out ? "bg-muted/20" : "")
                                    }
                                >
                                    {!out ? (
